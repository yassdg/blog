	...
	class Education_base_about extends WP_Widget {
		...
		public function form( $instance ) {
			...
			if( $page_id != 0 ){
				?>
                <p>
                    <label for="<?php echo $this->get_field_id( 'page_id' ); ?>"><?php _e( 'Select Page For About', 'education-base' ); ?>
                        :</label>
                    <br/>
				...
				?>
                <label><?php _e( 'Select Pages For About', 'education-base' ); ?>:</label>
                <br/>
                <small><?php _e( 'Add Page, Reorder and Remove. Please do not forget to add Icon and Excerpt  on selected pages.', 'education-base' ); ?></small>
